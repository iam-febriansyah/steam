            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Form Manajemen User</li>
                    </ol>
                </div>
            </div>
            <!-- End Bread crumb -->
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-title">
                                <h4><b>Manajemen User</b></h4>

                            </div>
                            <div class="card-body">
                                <div class="basic-elements">
                                    <form action="<?php echo base_url('Master_user/do_action'); ?>" method="POST" enctype="multipart/form-data" >

                                    <input type="hidden" class="form-control"  id="id_user" name="id_user" value="<?php echo (isset($id_user)) ? $id_user : ""; ?>" Required>
                                    <input type="hidden" class="form-control" name="status_data" value="<?php echo $status_data; ?>" id="status_data" >
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
												...
												<div class="form-group">
                                                    <label>NO HP</label>
                                                    <input type="text" class="form-control" id="no_telp" name="no_telp" value="<?php echo (isset($no_telp)) ? $no_telp : ""; ?>" >
                                                </div>
                                                <div class="form-group">
                                                    <label>Nama</label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="level" required>
                                                        ...
                                                        <option value="Kasir" <?php if($level == "Kasir"){ echo "selected"; }else{ ""; }; ?>> Kasir</option>
                                                        <option value="Admin" <?php if($level == "Admin"){ echo "selected"; }else{ ""; }; ?>> Admin</option>
                                                        <option value="Pelanggan" <?php if($level == "Pelanggan"){ echo "selected"; }else{ ""; }; ?>> Pelanggan</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <hr>
                                                <div class="form-group">
                                                    <a href="<?php echo base_url('Master_user/get_user'); ?>" class="btn btn-success">Cancel   </a>
