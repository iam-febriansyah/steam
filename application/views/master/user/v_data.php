            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Data Manajemen User</li>
                    </ol>
                </div>
            </div>
            <!-- End Bread crumb -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="<?php echo base_url('Master_user/form_insert'); ?>" target="" class="btn btn-primary"><i class="fa fa-add"> Tambah </i></a>
                                    <table id="myTable" class="table table-bordered table-striped" style="font-size:17px;">
                                        ...
                                        <tbody>
                                            <?php $no = 1; foreach($Get_user as $r){?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="<?php echo base_url('Master_user/do_delete/'.$r['id_user']); ?>" class="btn btn-danger btn-sm btn-flat"><i class="fa fa-trash"></i></a> 
                                                    <a href="<?php echo base_url('Master_user/form_edit/'.$r['id_user']); ?>" class="btn btn-primary  btn-sm btn-flat"><i class="fa fa-edit"></i></a>
                                                </td>
                                            </tr>
                                            <?php $no++; } ?>
                                        </tbody>
