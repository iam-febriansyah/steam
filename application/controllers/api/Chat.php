...
class Chat extends CI_Controller {
	...
	{
        $rows = $this->Model_api->Get_list_chat(" WHERE uTo.id_user = '".$id_user."' order by date_create DESC")->result_array();
		echo json_encode($rows);
    }

    public function getChatPerson($fromId, $toId)
	{
        $rows = $this->Model_api->Get_list_chat_person($fromId, $toId)->result_array();
		echo json_encode($rows);
    }
